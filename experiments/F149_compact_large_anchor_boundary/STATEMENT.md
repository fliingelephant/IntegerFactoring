# F149 candidate statement — compact large anchors canonicalize to an ordinary square-congruence target
...
for a public integer \(h\ge1\).  This is a Fermat-type difference of
squares for a multiple of \(N\), not a new decoder.
