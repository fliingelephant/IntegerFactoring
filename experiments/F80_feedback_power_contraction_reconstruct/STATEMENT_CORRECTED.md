# F80 corrected proof-blind reconstruction statement

Reconstruct or refute the claims below without reading the F80 candidate,
its hostile audit, C83 in the progress notes, the failed first reconstruction,
or any later F80 proof artifact. You may use the stated earlier P78 feedback
history as an input fact, but independently verify every group, order,
complexity, and numerical claim below.
