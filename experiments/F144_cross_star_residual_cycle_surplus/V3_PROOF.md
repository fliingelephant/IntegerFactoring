# F144 V3 proof — residual cycles and the square-root-scale obstruction
...
This proves the exact factor conclusion.  For fixed \(S\), combining (17)
and the added bound gives the exact possible interval
...
multiple \(m=1\) in (16) and the equality
\(6=\sqrt{35+1}\) in the corrected bound (17).
