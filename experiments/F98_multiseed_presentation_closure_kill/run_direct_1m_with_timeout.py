#!/usr/bin/env python3
"""Run the F98 diverse one-million-prime direct screen with a timeout."""
...
COMMAND = [
    ...
    "100",
    "--output",
    str(BASE / "DIRECT_1M_OUTPUT.json"),
]


def main() -> int:
    with (BASE / "DIRECT_1M_RUN.log").open("w", encoding="utf-8") as log:
