...
SOURCE = HERE / "test_frozen_batch_rescue.py"
...
def main() -> int:
    command = [sys.executable, str(SOURCE), "--case-cap", "7"]
    try:
        ...
        failed = HERE / f"RUN_FAILED_{stamp}_TIMEOUT.log"
        failed.write_text(
    ...
    if parsed.get("status") != "PASS":
        ...
        (HERE / f"OUTPUT_FAILED_{stamp}_CLAIM.json").write_text(
