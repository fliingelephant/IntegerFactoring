# F162 candidate — batch signed-inverse detection for section products
...
and comparable soft-linear storage. In particular, it is subquadratic in
the list length and remains quasipolynomial when the explicit list has
...
costs. It detects every support-two F156 hit whose exact block-intersection
