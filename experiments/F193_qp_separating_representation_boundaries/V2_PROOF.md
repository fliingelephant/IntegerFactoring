# Proof of the F193 V2 separating-representation boundaries
...
this is why V2 uses rank **at most** one and does not infer nonvanishing from
the conductor alone.
...
proves Section 4 and completes V2.
