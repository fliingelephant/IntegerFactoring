# F193 V2 candidate — narrow QP boundaries for separating representations

## Status and exact scope

This proof-only revision replaces the failed V1 candidate. No mathematical
computation is used.
...
F193 V2 removes four standard repackagings only. A live B5 route can still
