# F207 — a near-size spine can carry fixed-ratio side recursion, but the joint child congruences form an inversion torsor
...
and its standalone orientation boundaries. F207 differs in two ways:
