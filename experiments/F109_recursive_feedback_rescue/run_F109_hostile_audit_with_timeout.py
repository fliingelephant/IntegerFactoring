#!/usr/bin/env python3
"""Run the independent F109 hostile audit under a named hard timeout."""
...
def preserve_failure(label: str, log_text: str, stdout: str) -> None:
    ...
    stem = HERE / f"AUDIT_FAILED_{timestamp}_{label}"
...
def main() -> int:
    ...
    environment["DOT_SAGE"] = "/private/tmp/f109_hostile_audit_sage"
