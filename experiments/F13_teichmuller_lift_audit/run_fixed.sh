...
log_path="$experiment_dir/logs/A02.log"
output_path="$experiment_dir/output/A02.json"
...
set +e
/opt/homebrew/bin/timeout 60s python3 "$experiment_dir/fixed_probe_audit.py" \
