# F266-D02 algebra — canonical split-quadratic discriminant lifts
...
F266-D02 is a narrow repair of the immutable failed F266-D01 packet. It keeps
the same eight base families, five generators, word caps, two lift levels,
direct tickets, decoys, and P66 decoder. It changes no searched algebraic
family.
...
For each public base ID, D02 chooses one gauge triple
...
D02 executes these as eight global stages. It does not interleave a later
...
D02 serializes one residual row map per eligible bank and every final block
