# F268-D01 preregistration — canonical scalar-section multirow search
...
20,24,28,32 factor bits under a disjoint seed domain. Each requested row has
4,096 pair attempts. A shortfall is explicit and is not backfilled or
...
Prime requests have 200,000 candidates. Safe-prime requests have 1,000,000.
One ordinary corpus row has 128 pair retries. Neighbor scanning has 200,000
...
No discovered syntax can become a new template in D01.
