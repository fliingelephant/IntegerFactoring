#!/usr/bin/env python3
"""Frozen 600-second runner for the F165-R04 V2 blind reconstruction."""
...
SOURCE_SHA256 = "a3b1a94440d3e6e580bccc6efe189a73a86adc366c4e617acc06a5a56377b42f"

EXPERIMENT_DIR = Path(__file__).resolve().parent
REPOSITORY = EXPERIMENT_DIR.parent.parent
STATEMENT = EXPERIMENT_DIR / "V2_BLIND_STATEMENT.md"
SOURCE = EXPERIMENT_DIR / "f165_r04_v2_blind_reconstruct.py"
LOG = EXPERIMENT_DIR / "f165_r04_v2_blind_run.log"
OUTPUT = EXPERIMENT_DIR / "f165_r04_v2_blind_output.json"
