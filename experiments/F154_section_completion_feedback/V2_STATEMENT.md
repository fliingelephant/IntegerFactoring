# F154 V2 candidate — section completion is decoder-inert but can change a refinement-mediated feedback grammar
...
## 6. Exact finite witness for named-state expansion
...
This is only named-state expansion. The residue \(26\) is the inverse of the
already public residue \(3\). An unrestricted modular grammar already has
that modular information. The witness does not factor \(77\) and does not
give an all-input progress law.
